...
\input{slides/TwoPhaseNavierStokesLES/DiscreteModel.tex}
...
\movie[height = 0.135 \textwidth,width = 1.0\textwidth]{\includegraphics[height = 0.135 \textwidth,width = 1.0 \textwidth]{plunging_breakers.jpg}}{plunging_breakers.mp4}
% \includemedia[
%   width=0.6\linewidth,height=0.6\linewidth,
%   activate=onclick,
%   transparent,
%   addresource=marin.mp4,
%   flashvars={
%     source=marin.mp4     % same path as in addresource!
%    &loop=true           % loop video
%    &scaleMode=letterbox % preserve aspect ratio
%   }
% ]{}{player_flv_maxi.swf}
%\includemovie[controls,poster]{\textwidth}{0.75\textheight}{}
\end{frame}
...
\movie[height = 0.6 \textwidth,width = 1.0 \textwidth]{\includegraphics[height = 0.6 \textwidth,width = 1.0 \textwidth]{marin.png}}{marin.mp4}
% \includemedia[
%   width=0.6\linewidth,height=0.6\linewidth,
%   activate=onclick,
%   transparent,
